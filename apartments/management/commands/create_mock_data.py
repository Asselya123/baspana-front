...
class Command(BaseCommand):
    help = 'Creates mock data for the application'
    ...
    def handle(self, *args, **kwargs):
        ...
        self.stdout.write(self.style.SUCCESS(f'Created {len(builders)} builders, {len(apartments)} apartments, and {len(uploaded_files)} uploaded files.'))
    ...
    def _create_uploaded_files(self):
        ...
        with open(image_file_path, 'wb') as f:
            # Minimal JPEG file (hex values for a 1x1 pixel JPEG)
            f.write(bytes.fromhex(''))
        
        uploaded_files = []
        
        # Sample file data
        sample_files = [
            ('document1.txt', text_file_path, 'text/plain'),
            ('document2.txt', text_file_path, 'text/plain'),
            ('image1.jpg', image_file_path, 'image/jpeg'),
            ('image2.jpg', image_file_path, 'image/jpeg'),
            ('image3.jpg', image_file_path, 'image/jpeg'),
        ]
        
        # Create UploadedFile instances
        for filename, path, content_type in sample_files:
