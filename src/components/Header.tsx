...
export const Header = () => {
  return (
    <header className="flex flex-col items-center">
      <div className="flex items-center justify-between w-full gap-2 pt-4 pb-2 max-w-7xl">
      ...
      <div className="flex w-full items-center justify-center border-b border-t border-[#D1D4D7]">
        <div className="flex items-center justify-between w-full gap-2 py-3 max-w-7xl">
          <div className="flex items-center gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 text-[#008F91]">
              Личный кабинет
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
